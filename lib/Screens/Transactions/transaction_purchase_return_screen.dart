...
class TransactionPurchaseReturnScreen extends StatelessWidget {
  const TransactionPurchaseReturnScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Purchase Return Transactions'),
        elevation: 0,
      ),
      body: Container(
