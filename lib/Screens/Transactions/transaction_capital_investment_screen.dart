...
class TransactionCapitalInvestmentScreen extends StatelessWidget {
  const TransactionCapitalInvestmentScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Capital Investment Transactions'),
        elevation: 0,
      ),
      body: Container(
